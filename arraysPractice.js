...
var finder = function(num, randomNum) {
  var randomCounter = 0;
...
*/
 ...
 var removeItem = function(myGroceryList, itemRmv) {
  for (var i = 0; i < myGroceryList.length; i++) {
    if (myGroceryList[i] === itemRmv){
...
var addingFunct = function(arr1, arr2) {
